...
export default async function Obli(){
    ...
    const headerImage: Medium = await getHeaderImage("Obligatorisches")

    return (
        <main className="main">
            <div className={"page_title"} style={{backgroundImage: `url(${process.env.NEXT_PUBLIC_STORAGE}${headerImage.path})`}}><span className={"page_title_inner"}><h1>Obligatorisches</h1></span></div>
