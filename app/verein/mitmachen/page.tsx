...
export default async function Mitmachen(){
    ...
    const headerImage: Medium = await getHeaderImage("Mitmachen")

    return(
        <main className="main">
             <div className={"page_title"} style={{backgroundImage: `url(${process.env.NEXT_PUBLIC_STORAGE}${headerImage.path})`}}><span className={"page_title_inner"}><h1>Mitmachen</h1></span></div>
